...
Call.prototype.switchCamera = function (deviceId) {
  ...
  return navigator.mediaDevices.getUserMedia(constraints)
    .then(function (stream) {
      ...
      var videoSender = senders ?  senders.find(function (s) {
      ...
      videoSender.replaceTrack(videoTrackToSwitchTo).then(function() {
        ...
        // in the local stream.
        var oldVideoStreamTrack = this.localStream_.getVideoTracks()[0];
